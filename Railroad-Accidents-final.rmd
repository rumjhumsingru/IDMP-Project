...
```{r}
ggplot(df1_filtered, aes(x=(`Weather Condition`), y=(`Total Persons Injured`))) +
  geom_point() +
  geom_smooth() +
...
ggplot(df1_filtered, aes(x=(`Train Speed`), y=(`Total Persons Injured`))) +
  geom_point() +
  geom_smooth() +
  geom_smooth(method="lm", color="red") +
...
ggplot(df1_filtered, aes(x=log(`Train Speed`), y=log(`Total Persons Injured`))) +
  geom_point() +
  geom_smooth() +
  geom_smooth(method="lm", color="red") +
  labs(x="Train Speed", y="Total Persons Injured" , title="Total Persons Injured vs Train Speed Distribution") +
...
ggplot(df1_filtered, aes(x=(`Temperature`), y=(`Total Persons Injured`))) +
  geom_point() +
  geom_smooth() +
  geom_smooth(method="lm", color="red") +
...
ggplot(df1_filtered, aes(x=log(`Temperature`), y=log(`Total Persons Injured`))) +
  geom_point() +
  geom_smooth() +
  geom_smooth(method="lm", color="red") +
  labs(x="Temperature", y="Total Persons Injured", title="Total Persons Injured vs Temperature Distribution") +
...
ggplot(df1_filtered, aes(x=(`Positive Drug Tests`), y=(`Total Persons Injured`))) +
  geom_point() +
  geom_smooth() +
  geom_smooth(method="lm", color="red") +
...
ggplot(df1_filtered, aes(x=log(`First Car Position`), y=log(`Total Persons Injured`))) +
  geom_point() +
  geom_smooth() +
  geom_smooth(method="lm", color="red") +
